...
Generated: 2026-05-01T04:11:57.775334+00:00
...
- Host TaxID mapped rows: 1,557,974 (59.99%).
- Host context-recovered rows: 159,330.
- Host rows still requiring review: 1,022.
- Source-like host values mapped to a host and needing spot-check: 18,144.
- Source-like host values still unmapped and needing routing/review: 4,448.

## Source, Sample, And Environment Routing

- `Sample_Type_SD` present: 1,553,730 (59.83%).
- `Isolation_Source_SD` present: 1,488,231 (57.31%).
- `Environment_Medium_SD` present: 458,473 (17.65%).

## Geography And Time

- Country present: 2,261,186 (87.07%).

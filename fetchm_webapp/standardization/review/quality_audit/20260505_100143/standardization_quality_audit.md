...
Generated: 2026-05-05T10:05:20.462471+00:00
...
- Host TaxID mapped rows: 1,560,044 (60.04%).
- Host context-recovered rows: 159,883.
- Host rows still requiring review: 484.
- Source-like host values mapped to a host and needing spot-check: 17,944.
- Source-like host values still unmapped and needing routing/review: 4,461.

## Source, Sample, And Environment Routing

- `Sample_Type_SD` present: 1,312,920 (50.53%).
- `Isolation_Source_SD` present: 1,488,608 (57.29%).
- `Environment_Medium_SD` present: 206,569 (7.95%).

...
def latest_source_sample_environment_provenance(root: Path | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "review_signal_exact_cross_field_rows": int(metrics.get("review_signal_exact_cross_field_rows") or 0),
        "hard_exact_leakage_rows": int(metrics.get("hard_exact_leakage_rows") or 0),
        "intentional_cross_field_context_rows": int(metrics.get("intentional_cross_field_context_rows") or 0),
        "material_routed_to_sample_type_rows": int(metrics.get("material_routed_to_sample_type_rows") or 0),
        "environment_medium_routed_rows": int(metrics.get("environment_medium_routed_rows") or 0),
        "site_routed_rows": int(metrics.get("site_routed_rows") or 0),
        "metadata_descriptor_suppressed_rows": int(metrics.get("metadata_descriptor_suppressed_rows") or 0),
        "food_context_preserved_rows": int(metrics.get("food_context_preserved_rows") or 0),
